  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none text-text-secondary reveal reveal-delay-1">
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-text-primary">1. Introduction</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-text-primary">2. Information We Collect</h2>
        <h3 className="text-xl font-semibold mt-6 mb-3 text-text-primary">2.1 Data You Provide</h3>
        <p>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3 text-text-primary">2.2 Automatically Collected Data</h3>
        <p>We may collect:</p>
        <ul className="list-disc pl-6 mb-4 marker:text-primary">
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-text-primary">3. How We Use Your Information</h2>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-text-primary">4. Cookies</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-text-primary">5. Third-Party Services</h2>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-text-primary">6. Data Security</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-text-primary">7. Your Rights</h2>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-text-primary">9. Changes to This Policy</h2>
        <p>
